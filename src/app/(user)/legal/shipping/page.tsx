                    ...
                    <div className="prose prose-slate max-w-none">
                        <section className="mb-8">
                            ...
                            <p className="text-slate-600 leading-relaxed mb-4">
                                At InveztIN, we are committed to delivering your tiles and fittings safely and on time.
                        ...
                        <section className="mb-8">
                            ...
                            <p className="text-slate-600 leading-relaxed mb-4">
                                At InveztIN, we understand that timely delivery is crucial for your project planning.
                        ...
                        <section className="mb-8">
                            ...
                            <ul className="list-disc list-inside text-slate-600 space-y-2 ml-4 mb-4">
                                ...
                                <li>Contact us immediately at support@inveztin.com or support@inveztin.com</li>
                        ...
                        <section className="mb-8">
                            ...
                            <div className="bg-slate-50 p-6 rounded-lg border border-slate-200">
                                <p className="text-slate-700 font-medium mb-3">InveztIN - Shipping Department</p>
