...
const sidebarItems = [
  { title: "Dashboard", href: "/investor", icon: HiHome },
  { title: "Invest", href: "/investor/products", icon: HiTrendingUp },
  { title: "Invest Cart", href: "/investor/cart", icon: HiShoppingCart, showBadge: true },
  { title: "My Investments", href: "/investor/investments", icon: HiClipboardList },
  { title: "Earnings", href: "/investor/earnings", icon: HiCurrencyRupee },
];
    ...
    <aside className="fixed left-0 top-0 h-screen w-64 bg-slate-900 text-white border-r border-slate-800 z-40 flex flex-col">
      <div className="h-16 flex-shrink-0 flex items-center px-6 border-b border-slate-800">
        <Link href="/investor" className="flex items-center gap-2">
          ...
          <div>
            <h1 className="font-bold text-lg">Investor Panel</h1>
            <p className="text-xs text-slate-400">Grow your portfolio</p>
          </div>
        </Link>
      </div>
